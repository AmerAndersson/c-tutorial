/**
 * How we can implement a Trie in C/C++.
 * This is based on the tree data structure but does not necessarily store keys.
 * Here, each node only has a value, which is defined based on the position.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
